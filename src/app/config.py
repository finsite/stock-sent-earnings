...
def get_poller_name() -> str:
    ...
    return get_config_value("POLLER_NAME", "stock_sent_earnings")
...
def get_rabbitmq_queue() -> str:
    """RabbitMQ queue name."""
    return get_config_value("RABBITMQ_QUEUE", "stock_sent_earnings_queue")



def get_dlq_name() -> str:
    """Dead-letter queue name."""
    return get_config_value("DLQ_NAME", "stock_sent_earnings_dlq")
